...
def main():
    ...
    drone  = BasicArdu(connection_string='tcp:192.168.10.110:5760') #'tcp:10.228.150.1:5760')    # connect to Intel Aero using 'North, East, Down' Reference Basis
    ...
    for x in range(0,200):
        ...
        #drone.handle_takeoff(-27.4)  # takeoff alititude: 0.1 meters
